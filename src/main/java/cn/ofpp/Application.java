...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        // new 一个 女友
        GirlFriend girlFriend = new GirlFriend("未来的女友",
                "广东省", "广州市", "1999-08-08", "2023-05-20", "oQFk-oy6gm6kF_PnX24zgL-BAMSOxehw8");
       ...
       /* // new 一个 男友 也可单独针对一个friend设置模板ID 以达到不同人不同消息
        BoyFriend boyFriend = new BoyFriend("某男友",
                "江苏省", "南京市", "1999-08-08", "2011-04-16", "oQFk-oy6gm6kF_PnX24zgL-BAMSOxehw8", "5t7-Ksy8_rw-QmUkxf8J7Pe-QLQ2rBc7RWJi_pSmeh4");
